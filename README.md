...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-04 13:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/52b8aa5f-51a1-4a79-8de4-a5e4f7972b2a.git
$ cd 52b8aa5f-51a1-4a79-8de4-a5e4f7972b2a
```
